#ifndef DEF_INITIALIZE_CUBE_DISCRETIZATION
#define DEF_INITIALIZE_CUBE_DISCRETIZATION
...
//#define LS_MODE 1			// if LS_MODE is not defined (put in comment) then the tetrahedral algorithm is performed with level-set perturbations.1
